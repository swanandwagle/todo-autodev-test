...
@Schema(description = "Request body for full replacement of an existing task")
public class UpdateTaskRequest {
    ...
    @Schema(description = "Optimistic lock version (must match the stored version)", example = "0")
